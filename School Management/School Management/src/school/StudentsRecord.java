...
public class StudentsRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                " ID", "First Name", "Last Name", "Gender", "Father Name", "FatherOccupation", "Mother Name", "MotherOccupation", "Address", "Contact No", "Class"
            }
        ) {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        if (searchField.getText().isEmpty()) {
            ...
            jTable1.setModel(new DefaultTableModel(null, new Object[]{"ID", "First Name", "Last Name",
                "Gender", "Father Name","FatherOccupation", "Mother Name","MotherOccupation", "Address","Contact No","Admission in Class"}));
    ...
    private void btnRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefreshActionPerformed
        jTable1.setModel(new DefaultTableModel(null, new Object[]{"ID", "First Name", "Last Name",
            "Gender", "Father Name","FatherOccupation", "Mother Name","MotherOccupation", "Address","Contact No","Class"}));
        getStudentsRecord(jTable1, "");
    ...
    private void getStudentsRecord(JTable table, String searchValue) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                row[5] = rs.getString("foccu");
                row[6] = rs.getString("motherName");
                row[7] = rs.getString("moccu");
                row[8] = rs.getString("address");
                row[9] = rs.getString("contact");
                row[10]=rs.getString("class");
